...
void merge(vector<long long> &count, vector<pair<int, int> > &v, int left, int mid, int right) {
    ...
    void mergeSort(vector<long long> &count, vector<pair<int, int> > &v, int left, int right) {
        if (left >= right) 
            return;
